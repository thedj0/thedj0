...
function generateNotes() {
    ...
    var regex = /(?:\b\d{3}[-.\s]?\d{2}[-.\s]?\d{4}\b)|(?:(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|ext\.?|extension)\s*(\d+))?)|(?:(?:\b[A-Za-z0-9_]+\.[A-Za-z0-9_]+\.[A-Za-z0-9_.-]+\b)|(?:(?:(?:(?:[a-zA-Z0-9-_=]+)\.){2,}[a-zA-Z0-9-_=]+)|(?:(?:[a-zA-Z0-9-_=]+)\.(?:[a-zA-Z0-9-_=]+))))|(?:\b[\w-]+@([\w-]+\.)+[\w-]+\b)|(?:\b[\w\d-]{36}\b)/g;
...
function detectSensitiveInfo() {
    ...
    var regex = /(?:\b[\w-]+@([\w-]+\.)+[\w-]+\b)|(?:(?:\b[\w\d-]{36}\b)|(?:(?:\b\d{3}[-.\s]?\d{2}[-.\s]?\d{4}\b)|(?:(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|ext\.?|extension)\s*(\d+))?)|(?:(?:\b[A-Za-z0-9_]+\.[A-Za-z0-9_]+\.[A-Za-z0-9_.-]+\b)|(?:(?:(?:(?:[a-zA-Z0-9-_=]+)\.){2,}[a-zA-Z0-9-_=]+)|(?:(?:[a-zA-Z0-9-_=]+)\.(?:[a-zA-Z0-9-_=]+))))))/g;
